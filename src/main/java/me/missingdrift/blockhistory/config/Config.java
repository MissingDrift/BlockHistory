package me.missingdrift.blockhistory.config;

import me.missingdrift.blockhistory.*;
...
import static me.missingdrift.blockhistory.util.Utils.parseTimeSpec;
...
public class Config {
    ...
    public static void load(blockhistory blockhistory) throws DataFormatException, IOException {
        ...
        for (final String world : loggedWorlds) {
            worldConfigs.put(world, new WorldConfig(world, new File(blockhistory.getDataFolder(), friendlyWorldname(world) + ".yml")));
        }
