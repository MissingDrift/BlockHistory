...
public class BukkitUtils {
    ...
    public static ItemStack[] compareInventories(ItemStack[] items1, ItemStack[] items2) {
        ...
        for (ItemStack current : items2) {
            try {
                ...
                blockhistory.getInstance().getLogger().log(Level.SEVERE, "Could not clone ItemStack, probably Spigot bug SPIGOT-6025", e); // SPIGOT-6025
            }
        }
    ...
    public static TextComponent toString(ItemStack stack) {
        ...
        try {
            ...
            blockhistory.getInstance().getLogger().log(Level.SEVERE, "Failed to convert Itemstack to JSON", e);
