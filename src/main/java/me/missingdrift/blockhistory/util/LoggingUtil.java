package me.missingdrift.blockhistory.util;
...
import static me.missingdrift.blockhistory.config.Config.mb4;

public class LoggingUtil {

    public static void smartblockhistoryPlace(Consumer consumer, Actor actor, BlockState replaced, BlockState placed) {
    ...
    public static void smartLogFallables(Consumer consumer, Actor actor, Block origin) {
        ...
        if (wcfg.isLogging(Logging.SCAFFOLDING) && checkBlock.getType() == Material.SCAFFOLDING && consumer.getblockhistory().getScaffoldingLogging() != null) {
            consumer.getblockhistory().getScaffoldingLogging().addScaffoldingBreaker(actor, checkBlock);
        }
    }

    public static void smartblockhistoryBreak(Consumer consumer, Actor actor, Block origin) {
        smartblockhistoryReplace(consumer, actor, origin, null);
    }

    public static void smartblockhistoryReplace(Consumer consumer, Actor actor, Block origin, BlockData replacedWith) {
