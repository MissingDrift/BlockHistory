...
import static me.missingdrift.blockhistory.config.Config.logCreeperExplosionsAsPlayerWhoTriggeredThese;
import static me.missingdrift.blockhistory.util.BukkitUtils.getContainerBlocks;
...
public class ExplosionLogging extends LoggingListener {
    ...
    public ExplosionLogging(blockhistory lb) {
        super(lb);
    }
